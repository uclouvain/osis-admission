    ...
    def annotate_with_student_registration_id(self):
        return self.annotate(
            ...
            student_registration_id=Case(
                When(
                    Q(person_merge_proposal_noma__isnull=False) & ~Q(person_merge_proposal_noma=''),
                    then='person_merge_proposal_noma',
                ),
...
class BaseAdmission(CommentDeleteMixin, models.Model):
    ...
    professional_valuated_experiences = models.ManyToManyField(
        ...
        through='admission.models.valuated_epxeriences.AdmissionProfessionalValuatedExperiences',
    )
    educational_valuated_experiences = models.ManyToManyField(
        ...
        through='admission.models.valuated_epxeriences.AdmissionEducationalValuatedExperiences',
    )
