...
class IListeQuestionsSpecifiquesRepository(interface.AbstractRepository):
    @classmethod
    @abc.abstractmethod
    ...
    @classmethod
    def search(cls, **kwargs) -> List['ListeDesQuestionsSpecifiquesDeLaFormation']:  # type: ignore[override]
        raise NotImplementedError
