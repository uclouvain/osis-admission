...
from admission.ddd.projet_doctoral.doctorat.formation.dtos import SeminaireCommunicationDTO
from base.ddd.utils.business_validator import BusinessValidator


@attr.dataclass(frozen=True, slots=True)
class ShouldCommunicationSeminaireEtreComplete(BusinessValidator):
    ...
    def validate(self, *args, **kwargs):
        if not all(
            [
                ...
                self.communication.orateur_oratrice,
            ]
        ):
