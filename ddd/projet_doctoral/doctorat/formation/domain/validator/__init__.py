...
__all__ = [
    "ShouldCommunicationConferenceEtreComplete",
    "ShouldCommunicationEtreComplete",
    "ShouldConferenceEtreComplete",
    "ShouldPublicationConferenceEtreComplete",
    "ShouldPublicationEtreComplete",
    "ShouldSejourEtreComplet",
    "ShouldCommunicationSejourEtreComplete",
    "ShouldSeminaireEtreComplet",
