...
from admission.ddd.parcours_doctoral.formation.domain.model.enums import ChoixComiteSelection
from admission.ddd.parcours_doctoral.formation.domain.validator.exceptions import ActiviteNonComplete
from admission.ddd.parcours_doctoral.formation.dtos import CommunicationDTO
from base.ddd.utils.business_validator import BusinessValidator


@attr.dataclass(frozen=True, slots=True)
class ShouldCommunicationEtreComplete(BusinessValidator):
    ...
    def validate(self, *args, **kwargs):
        if not all(
            [
                ...
                self.communication.pays,
                self.communication.ville,
