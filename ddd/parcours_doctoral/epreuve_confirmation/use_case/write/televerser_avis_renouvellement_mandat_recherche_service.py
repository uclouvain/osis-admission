...
def televerser_avis_renouvellement_mandat_recherche(
    cmd: 'TeleverserAvisRenouvellementMandatRechercheCommand',
    ...
    # WHEN
    epreuve_confirmation.televerser_demande_renouvellement_bourse(
