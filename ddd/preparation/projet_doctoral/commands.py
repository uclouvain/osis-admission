...
class InitierPropositionCommand(interface.CommandRequest):
    ...
    documents_projet: List[str] = field(default_factory=list)
    graphe_gantt: List[str] = field(default_factory=list)
    proposition_programme_doctoral: List[str] = field(default_factory=list)
    projet_formation_complementaire: List[str] = field(default_factory=list)
    lettres_recommandation: List[str] = field(default_factory=list)
...
class DefinirCotutelleCommand(interface.CommandRequest):
    ...
    institution: Optional[str] = ''
    demande_ouverture: List[str] = field(default_factory=list)
    convention: List[str] = field(default_factory=list)
    autres_documents: List[str] = field(default_factory=list)
...
@attr.dataclass(frozen=True, slots=True)
class FiltrerPropositionsCommand(interface.QueryRequest):
    numero: Optional[str] = ''
    etat: Optional[str] = ''
