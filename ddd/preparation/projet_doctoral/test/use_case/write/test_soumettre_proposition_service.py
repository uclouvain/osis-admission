...
class TestVerifierPropositionServiceCommun(SimpleTestCase):
    def setUp(self) -> None:
        ...
        for date_patch in [
            'admission.ddd.preparation.projet_doctoral.use_case.write.soumettre_proposition_service.datetime',
            'admission.ddd.preparation.projet_doctoral.domain.model.proposition.datetime',
        ]:
