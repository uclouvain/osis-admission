...
from admission.ddd.admission.projet_doctoral.preparation.commands import VerifierProjetCommand
...
from admission.ddd.admission.projet_doctoral.preparation.domain.service.verifier_projet_doctoral import (
    VerifierProjetDoctoral,
)
