...
from admission.ddd.admission.projet_doctoral.preparation.domain.service.verifier_proposition import VerifierProposition
...
from admission.ddd.admission.projet_doctoral.validation.domain.service.demande import DemandeService
