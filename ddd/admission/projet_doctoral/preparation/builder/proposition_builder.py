...
from admission.ddd.admission.projet_doctoral.preparation.domain.model.doctorat import DoctoratIdentity
from admission.ddd.admission.projet_doctoral.preparation.domain.model.proposition import (
    Proposition,
)
from admission.ddd.admission.projet_doctoral.preparation.domain.validator.validator_by_business_action import (
