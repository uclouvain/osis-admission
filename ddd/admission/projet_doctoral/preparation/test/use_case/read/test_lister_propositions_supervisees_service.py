...
from admission.ddd.admission.projet_doctoral.preparation.commands import ListerPropositionsSuperviseesQuery
from admission.ddd.admission.projet_doctoral.preparation.test.factory.person import PersonneConnueUclDTOFactory
...
class TestListerPropositionsSuperviseesService(SimpleTestCase):
    def setUp(self) -> None:
