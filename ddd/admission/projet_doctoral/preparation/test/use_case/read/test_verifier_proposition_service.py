...
from admission.ddd.admission.projet_doctoral.preparation.commands import VerifierPropositionCommand
...
from admission.ddd.admission.projet_doctoral.preparation.test.factory.groupe_de_supervision import (
...
from admission.infrastructure.admission.projet_doctoral.preparation.domain.service.in_memory.profil_candidat import (
    DiplomeEtudeSecondaire,
    ProfilCandidatInMemoryTranslator,
    ExperienceNonAcademique,
)
from admission.infrastructure.admission.projet_doctoral.preparation.repository.in_memory.groupe_de_supervision import (
...
class TestVerifierPropositionServiceCommun(SimpleTestCase):
    def setUp(self) -> None:
        ...
        patcher = mock.patch(
            'admission.ddd.admission.projet_doctoral.preparation.use_case.read.verifier_proposition_service.datetime'
        )
