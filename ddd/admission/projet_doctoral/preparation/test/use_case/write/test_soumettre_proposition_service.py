...
from admission.ddd.admission.projet_doctoral.preparation.commands import SoumettrePropositionCommand
...
class TestVerifierPropositionServiceCommun(SimpleTestCase):
    def setUp(self) -> None:
        ...
        for date_patch in [
            'admission.ddd.admission.projet_doctoral.preparation.use_case.write.soumettre_proposition_service.datetime',
            'admission.ddd.admission.projet_doctoral.preparation.domain.model.proposition.datetime',
        ]:
