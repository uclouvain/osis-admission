...
from admission.ddd.admission.projet_doctoral.preparation.test.factory.proposition import _PropositionIdentityFactory
from admission.ddd.admission.projet_doctoral.validation.domain.model._enums import ChoixStatutSIC, ChoixStatutCDD
from admission.ddd.admission.projet_doctoral.validation.domain.model._profil_candidat import ProfilCandidat
from admission.ddd.admission.projet_doctoral.validation.domain.model.demande import DemandeIdentity, Demande
