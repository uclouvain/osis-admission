...
class TypeEmplacementDocument(ChoiceEnum):
    ...
    LIBRE_CANDIDAT_SIC = _('Free and uploaded by SIC for the candidate')
    LIBRE_CANDIDAT_FAC = _('Free and uploaded by FAC for the candidate')
...
class IdentifiantBaseEmplacementDocument(ChoiceEnum):
    ...
    LIBRE_CANDIDAT = _('Additional documents to complete by the candidate')
...
IDENTIFIANT_BASE_EMPLACEMENT_DOCUMENT_LIBRE_PAR_TYPE = {
    ...
    TypeEmplacementDocument.LIBRE_CANDIDAT_FAC.name: IdentifiantBaseEmplacementDocument.LIBRE_GESTIONNAIRE.name,
    TypeEmplacementDocument.LIBRE_CANDIDAT_SIC.name: IdentifiantBaseEmplacementDocument.LIBRE_GESTIONNAIRE.name,
