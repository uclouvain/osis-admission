...
class TypeDocument(ChoiceEnum):
    ...
    DEPOSE_SIC = _('Uploaded by SIC')
    DEPOSE_FAC = _('Uploaded by FAC')
    DEMANDE_SIC = _('Requested by SIC')
    DEMANDE_FAC = _('Requested by FAC')
...
class OngletsDemande(ChoiceEnum):
    ...
    CONFIRMATION = pgettext_lazy('tab', 'Confirmation')
...
class DocumentsEtudesSecondaires(ChoiceEnum):
    ...
    DIPLOME_ETRANGER_DECISION_FINAL_EQUIVALENCE_UE = _('A double-sided copy of the final equivalence decision')
    DIPLOME_ETRANGER_PREUVE_DECISION_EQUIVALENCE = _('Proof of the final equivalence decision')
    DIPLOME_ETRANGER_DECISION_FINAL_EQUIVALENCE_HORS_UE = _('A double-sided copy of the final equivalence decision')
...
class DocumentsCurriculum(ChoiceEnum):
    DIPLOME_EQUIVALENCE = _(
        'Decision of equivalence for your diploma(s) giving access to the training, if this(these) has(have) been '
        'obtained outside Belgium'
    )
