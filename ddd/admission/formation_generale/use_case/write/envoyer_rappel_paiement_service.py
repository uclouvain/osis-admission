...
#
# ##############################################################################
from admission.ddd.admission.formation_generale.commands import EnvoyerRappelPaiementCommand
...
def envoyer_rappel_paiement(
    ...
    # WHEN
    paiement_frais_dossier_service.verifier_proposition_en_attente_paiement_suite_demande_gestionnaire(
