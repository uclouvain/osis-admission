...
from admission.ddd.admission.formation_generale.commands import AnnulerReclamationDocumentsAuCandidatCommand
...
def annuler_reclamation_documents_au_candidat(
    ...
    proposition.annuler_reclamation_documents(auteur_modification=cmd.auteur, par_fac=cmd.par_fac)
