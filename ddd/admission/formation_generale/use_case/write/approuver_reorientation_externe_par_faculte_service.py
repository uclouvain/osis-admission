...
from admission.ddd.admission.formation_generale.commands import ApprouverReorientationExterneParFaculteCommand
...
def approuver_reorientation_externe_par_faculte(
    cmd: ApprouverReorientationExterneParFaculteCommand,
    ...
    # WHEN
    proposition.approuver_reorientation_externe_par_fac(
