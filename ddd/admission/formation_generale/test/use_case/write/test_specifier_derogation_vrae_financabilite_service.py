...
class TestSpecifierDerogationVraeFinancabilite(TestCase):
    @classmethod
    ...
    def test_should_specifier_derogation_refus_etre_ok(self):
        command = SpecifierDerogationVraeFinancabiliteCommand(
            uuid_proposition='uuid-MASTER-SCI-CONFIRMED',
            gestionnaire='0123456789',
            derogation_vrae=True,
        )
        ...
        self.assertIs(proposition.financabilite_derogation_vrae, True)
