...
from admission.ddd.admission.formation_generale.commands import (
    ...
    RemplacerEmplacementDocumentCommand,
...
class TestRemplacerEmplacementDocument(TestCase):
    def setUp(self) -> None:
    ...
    def test_should_remplacer_emplacement_document_sic_reclamable(self, freeze_time):
    ...
    @freezegun.freeze_time('2023-01-01', as_kwarg='freeze_time')
    def test_should_remplacer_emplacement_document_sic_non_reclamable_candidat(self, freeze_time):
        # Initialiser un emplacement de document libre sic
        identifiant_emplacement_document_depose = self.message_bus.invoke(
            InitialiserEmplacementDocumentLibreNonReclamableCommand(
                uuid_proposition=self.uuid_proposition,
    ...
    @freezegun.freeze_time('2023-01-01', as_kwarg='freeze_time')
    def test_should_remplacer_emplacement_document_fac_non_reclamable_candidat(self, freeze_time):
        # Initialiser un emplacement de document libre fac
        identifiant_emplacement_document_depose = self.message_bus.invoke(
            InitialiserEmplacementDocumentLibreNonReclamableCommand(
                uuid_proposition=self.uuid_proposition,
