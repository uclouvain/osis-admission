...
class TestEnvoyerRappelPaiement(TestCase):
    @classmethod
    ...
    def setUp(self) -> None:
        ...
        self.proposition.checklist_actuelle.frais_dossier.statut = ChoixStatutChecklist.GEST_BLOCAGE

        self.command = EnvoyerRappelPaiementCommand(
            uuid_proposition='uuid-MASTER-SCI-CONFIRMED',
            gestionnaire='987654321',
        )

    def test_should_envoyer_rappel_paiement_etre_ok(self):
    ...
    def test_should_lever_exception_si_frais_deja_payes_a_la_soumission(self):
        with mock.patch.multiple(
            ...
            with self.assertRaises(PropositionDoitEtreEnAttenteDePaiementException):
    ...
    def test_should_lever_exception_si_pas_deja_demandes_par_gestionnaire(self):
        with mock.patch.multiple(
            self.proposition.checklist_actuelle.frais_dossier,
