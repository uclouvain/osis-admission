...
class TestSpecifierDerogationDelegueVrae(TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        super().setUpClass()
        cls.proposition_repository = PropositionInMemoryRepository()
        cls.message_bus = message_bus_in_memory_instance
        cls.command = SpecifierDerogationDelegueVraeSicCommand
    ...
    def setUp(self) -> None:
        ...
        self.parametres_commande_par_defaut = {
            ...
            'derogation': BesoinDeDerogationDelegueVrae.DEROGATION_VRAE.name,
            'commentaire': 'commentaire',
            'justificatif': ['file1.pdf'],
    ...
    def test_should_etre_ok_si_statut_correct(self):
        ...
        self.assertEqual(proposition.derogation_delegue_vrae, BesoinDeDerogationDelegueVrae.DEROGATION_VRAE)
        self.assertEqual(proposition.derogation_delegue_vrae_commentaire, 'commentaire')
        self.assertEqual(proposition.justificatif_derogation_delegue_vrae, ['file1.pdf'])
