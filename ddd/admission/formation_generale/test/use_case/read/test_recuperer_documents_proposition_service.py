...
class RecupererDocumentsPropositionTestCase(TestCase):
    ...
    def test_recuperer_documents_proposition(self):
        ...
        document: Optional[EmplacementDocumentDTO] = next(
            (doc for doc in documents if doc.identifiant == 'LIBRE_GESTIONNAIRE.24de0c3d-3c06-4c93-8eb4-c8648f04f140'),
            None,
        )
        self.assertIsNotNone(document)
        self.assertEqual(document.libelle, 'My candidate sic file')
        self.assertEqual(document.libelle_langue_candidat, 'My candidate sic file')
        self.assertEqual(document.document_uuids, ['24de0c3d-3c06-4c93-8eb4-c8648f04f140'])
        ...
        self.assertEqual(document.document_soumis_le, datetime.datetime(2023, 1, 5))
        ...
        document: Optional[EmplacementDocumentDTO] = next(
            (doc for doc in documents if doc.identifiant == 'LIBRE_GESTIONNAIRE.24de0c3d-3c06-4c93-8eb4-c8648f04f141'),
            None,
        )
        self.assertIsNotNone(document)
        self.assertEqual(document.libelle, 'My candidate fac file')
        self.assertEqual(document.libelle_langue_candidat, 'My candidate fac file')
        self.assertEqual(document.document_uuids, ['24de0c3d-3c06-4c93-8eb4-c8648f04f141'])
        ...
        self.assertEqual(document.document_soumis_le, datetime.datetime(2023, 1, 1))
        self.assertEqual(document.reclame_le, None)
        self.assertEqual(document.dernier_acteur, None)
        self.assertEqual(document.derniere_action_le, None)
        self.assertEqual(document.a_echeance_le, None)
