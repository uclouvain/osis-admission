...
class CompleterEmplacementsDocumentsParCandidatTestCase(SimpleTestCase):
    def setUp(self) -> None:
        ...
        self.proposition = self.proposition_repository.get(PropositionIdentity(uuid='uuid-USCC4'))
        ...
        self.id_document_libre = 'LIBRE_CANDIDAT.26de0c3d-3c06-4c93-8eb4-c8648f04f146'
    ...
    def test_should_completer_emplacements_documents_demandes(self, freeze_time):
        # Le gestionnaire réclame les emplacements de documents
        self.message_bus.invoke(
            ReclamerDocumentsAuCandidatCommand(
                uuid_proposition='uuid-USCC4',
        ...
        self.assertEqual(proposition.statut, ChoixStatutPropositionContinue.COMPLETEE_POUR_FAC)

    @freezegun.freeze_time("2023-01-03", as_kwarg="freeze_time")
    def test_should_completer_emplacements_documents_demandes_immediatement(self, freeze_time):
        # Le gestionnaire réclame les emplacements de documents
        self.message_bus.invoke(
            ReclamerDocumentsAuCandidatCommand(
                uuid_proposition='uuid-USCC4',
    ...
    def test_should_lever_exception_si_documents_non_reclames_sont_completes(self):
        ...
        # Le candidat remplit un document non demandé
        with self.assertRaises(MultipleBusinessExceptions) as context:
            self.message_bus.invoke(
                CompleterEmplacementsDocumentsParCandidatCommand(
                    uuid_proposition='uuid-USCC4',
