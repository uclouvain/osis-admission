...
from admission.ddd.admission.formation_continue.commands import MettreEnAttenteCommand
...
class MettreEnAttenteTestCase(SimpleTestCase):
    def setUp(self) -> None:
        ...
        self.cmd = MettreEnAttenteCommand(
            uuid_proposition='uuid-USCC2',
            gestionnaire="gestionnaire",
            objet_message="objet",
            corps_message="corps",
            motif=ChoixMotifAttente.COMPLET.name,
            autre_motif="",
        )
    ...
    def test_should_mettre_en_attente(self):
        ...
        self.assertEqual(proposition.statut, ChoixStatutPropositionContinue.EN_ATTENTE)
