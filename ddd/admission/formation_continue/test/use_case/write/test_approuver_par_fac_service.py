...
from admission.ddd.admission.formation_continue.commands import ApprouverParFacCommand
...
class ApprouverParFacTestCase(SimpleTestCase):
    def setUp(self) -> None:
        ...
        self.cmd = ApprouverParFacCommand(
    ...
    def test_should_approuver_par_fac(self):
