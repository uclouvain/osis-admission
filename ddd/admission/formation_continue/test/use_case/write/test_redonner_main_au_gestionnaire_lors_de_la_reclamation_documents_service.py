...
class RedonnerMainAuGestionnaireLorsDeLaReclamationDocumentsTestCase(SimpleTestCase):
    ...
    def test_should_redonner_main_au_gestionnaire_fac(self):
        self.proposition.statut = ChoixStatutPropositionContinue.A_COMPLETER_POUR_FAC
        ...
        self.assertEqual(proposition_a_jour.statut, ChoixStatutPropositionContinue.COMPLETEE_POUR_FAC)
