...
@dataclass
class GenererDocumentAnalysePropositionAutorisationHandler(EventHandler):
    def handle(
        self,
        msg_bus: 'MessageBus',
        event: Union['PropositionFormationContinueValideeEvent',],
    ) -> None:
        msg_bus.invoke(GenererDocumentAnalysePropositionAutorisationCommand(uuid_proposition=event.entity_id.uuid))
