...
from admission.ddd.admission.formation_continue.commands import ReclamerDocumentsAuCandidatCommand
...
def reclamer_documents_au_candidat(
    ...
    proposition.reclamer_documents(auteur_modification=cmd.auteur)
    ...
    historique.historiser_demande_complements(proposition=proposition, acteur=cmd.auteur, message=message)
