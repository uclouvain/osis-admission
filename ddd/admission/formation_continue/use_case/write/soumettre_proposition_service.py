...
from admission.ddd.admission.formation_continue.domain.service.checklist import (
    Checklist,
)
...
from admission.ddd.admission.formation_continue.domain.service.verifier_proposition import (
    VerifierProposition,
)
...
def soumettre_proposition(
    ...
    notification.confirmer_soumission(
        proposition=proposition,
