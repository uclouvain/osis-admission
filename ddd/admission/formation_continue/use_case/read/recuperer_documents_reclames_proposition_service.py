...
from admission.ddd.admission.formation_continue.commands import RecupererDocumentsReclamesPropositionQuery
...
def recuperer_documents_reclames_proposition(
    cmd: 'RecupererDocumentsReclamesPropositionQuery',
