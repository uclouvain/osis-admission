...
from admission.ddd.admission.shared_kernel.commands import RecupererExperienceNonAcademiqueQuery, RecupererExperienceAcademiqueQuery
...
class TestRecupererExperienceAcademique(TestCase):
    def setUp(self) -> None:
        self.message_bus = message_bus_in_memory_instance

    def test_should_recuperer_experience_academique(self):
        cmd = RecupererExperienceAcademiqueQuery(
            uuid_proposition='uuid-MASTER-SCI',
            global_id='0123456789',
            uuid_experience='9cbdf4db-2454-4cbf-9e48-55d2a9881ee1',
        )
