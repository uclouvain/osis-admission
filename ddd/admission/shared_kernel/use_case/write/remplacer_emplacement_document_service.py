...
from admission.ddd.admission.shared_kernel.commands import RemplacerEmplacementDocumentCommand
...
def remplacer_emplacement_document(
    cmd: 'RemplacerEmplacementDocumentCommand',
