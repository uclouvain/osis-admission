...
class TestRecupererInformationsDestinatairesService(SimpleTestCase):
    def setUp(self) -> None:
        self.annee = 2022
    ...
    def test_doit_retourner_informations_destinataires(self):
        cmd = RecupererInformationsDestinatairesQuery(
            annee=self.annee,
    ...
    def test_doit_retourner_liste_vide_si_pas_trouvees(self):
        cmd = RecupererInformationsDestinatairesQuery(
            annee=self.annee,
