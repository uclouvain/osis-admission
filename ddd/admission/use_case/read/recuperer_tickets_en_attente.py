...
def recuperer_tickets_en_attente(
    cmd: 'RetrieveListeTicketsEnAttenteQuery',
    digit_repository: 'IDigitRepository',
) -> List[StatutTicketPersonneDTO]:
    return digit_repository.retrieve_list_pending_person_tickets()
