...
class PropositionBuilder(interface.RootEntityBuilder):
    ...
    def initier_proposition(
        ...
        if cmd.pre_admission_associee and 'parcours_doctoral' in apps.app_configs:
    ...
    def initier_nouvelle_proposition_attachee_a_pre_admission(
        ...
        proposition.completer(
            ...
            institut_these=str(parcours_doctoral.projet.institut_these)
            if parcours_doctoral.projet.institut_these
            else '',
        ...
        proposition.completer_comptabilite(
            ...
            type_situation_assimilation=pre_admission.comptabilite.type_situation_assimilation.name
            if pre_admission.comptabilite.type_situation_assimilation
            else '',
            sous_type_situation_assimilation_1=pre_admission.comptabilite.sous_type_situation_assimilation_1.name
            ...
            sous_type_situation_assimilation_2=pre_admission.comptabilite.sous_type_situation_assimilation_2.name
            ...
            sous_type_situation_assimilation_3=pre_admission.comptabilite.sous_type_situation_assimilation_3.name
            ...
            preuve_allocations_chomage_pension_indemnite=pre_admission.comptabilite.preuve_allocations_chomage_pension_indemnite,
            attestation_cpas=pre_admission.comptabilite.attestation_cpas,
            relation_parente=pre_admission.comptabilite.relation_parente.name if pre_admission.comptabilite.relation_parente else '',
            sous_type_situation_assimilation_5=pre_admission.comptabilite.sous_type_situation_assimilation_5.name
            ...
            annexe_25_26_protection_parent=pre_admission.comptabilite.annexe_25_26_refugies_apatrides_decision_protection_parent,
            ...
            sous_type_situation_assimilation_6=pre_admission.comptabilite.sous_type_situation_assimilation_6.name
            ...
            type_numero_compte=pre_admission.comptabilite.type_numero_compte.name
