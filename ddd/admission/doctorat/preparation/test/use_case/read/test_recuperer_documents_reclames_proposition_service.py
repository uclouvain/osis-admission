...
class RecupererDocumentsReclamesPropositionTestCase(SimpleTestCase):
    def setUp(self):
        self.cmd = RecupererDocumentsReclamesPropositionQuery(uuid_proposition='uuid-SC3DP-promoteur-membre')
    ...
    def test_recuperer_documents_reclames_proposition(self):
        ...
        self.assertEqual(curriculum.document_uuids, ['file_token.pdf'])
        ...
        document: Optional[EmplacementDocumentDTO] = next(
            (doc for doc in documents if doc.identifiant == 'LIBRE_CANDIDAT.36de0c3d-3c06-4c93-8eb4-c8648f04f142'),
            None,
        )
