...
class TestVerifierCurriculumApresSoumissionService(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.proposition_doctorale = self.proposition_in_memory.get(
            entity_id=PropositionIdentityBuilder.build_from_uuid(
        ...
        self.cmd = VerifierCurriculumApresSoumissionQuery(uuid_proposition=self.proposition_doctorale.entity_id.uuid)
