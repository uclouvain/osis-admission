...
class TestPasserEtatPrisEnChargeDecisionCdd(TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        super().setUpClass()
        cls.proposition_repository = PropositionInMemoryRepository()
        cls.message_bus = message_bus_in_memory_instance
        cls.command = PasserEtatPrisEnChargeDecisionCddCommand
    ...
    def test_should_etre_ok_si_statuts_corrects(self):
        ...
        statut_pris_en_charge = statuts_decision_cdd['PRIS_EN_CHARGE']
        ...
        self.assertEqual(proposition.checklist_actuelle.decision_cdd.statut, statut_pris_en_charge.statut)
        self.assertEqual(proposition.checklist_actuelle.decision_cdd.extra, statut_pris_en_charge.extra)
