...
class RedonnerMainAuGestionnaireLorsDeLaReclamationDocumentsTestCase(SimpleTestCase):
    def setUp(self) -> None:
        ...
        self.proposition = self.proposition_repository.get(PropositionIdentity(uuid='uuid-SC3DP-promoteur-membre'))
    ...
    def test_should_redonner_main_au_gestionnaire_fac(self):
        ...
        self.assertEqual(proposition_a_jour.statut, ChoixStatutPropositionDoctorale.COMPLETEE_POUR_FAC)
        self.assertIsNone(proposition_a_jour.echeance_demande_documents)

    def test_should_redonner_main_au_gestionnaire_sic(self):
        self.proposition.statut = ChoixStatutPropositionDoctorale.A_COMPLETER_POUR_SIC
        self.proposition.documents_demandes = {}
        ...
        self.assertEqual(resultat, proposition_a_jour.entity_id)
        self.assertEqual(proposition_a_jour.statut, ChoixStatutPropositionDoctorale.COMPLETEE_POUR_SIC)
        self.assertIsNone(proposition_a_jour.echeance_demande_documents)
