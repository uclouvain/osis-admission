...
class IElementsConfirmation(interface.DomainService):
    ...
    REGLEMENT_DOCTORAT = _(
        'Je déclare avoir pris connaissance et avoir compris le règlement de la commission générale du '
        'doctorat et des conditions particulières de la commission doctorale de domaine, auxquels j\'adhère'
    )
    REGLEMENT_DOCTORAT_DEONTOLOGIE = _(
        'Je confirme avoir pris connaissance du règlement doctoral relatif à la déontologie de la '
        'recherche et certifie que mon projet est conforme à ce règlement'
    )
    REGLEMENT_GENERAL = _(
