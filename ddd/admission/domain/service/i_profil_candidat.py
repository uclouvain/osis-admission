...
class IProfilCandidatTranslator(interface.DomainService):
    ...
    def recuperer_derniers_etablissements_superieurs_communaute_fr_frequentes(
        ...
        annee_minimale: int,
    ) -> Optional[DerniersEtablissementsSuperieursCommunauteFrancaiseFrequentes]:
        derniere_annee = 0
        noms = []
        ...
        if noms:
            return DerniersEtablissementsSuperieursCommunauteFrancaiseFrequentes(annee=derniere_annee, noms=noms)
