...
from admission.ddd.doctorat.formation.domain.model._enums import ChoixComiteSelection
from admission.ddd.doctorat.formation.domain.validator.exceptions import ActiviteNonComplete
from admission.ddd.doctorat.formation.dtos import CommunicationDTO
