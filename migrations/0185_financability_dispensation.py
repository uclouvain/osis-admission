...
class Migration(migrations.Migration):
    ...
    <p>After reviewing your academic curriculum and in accordance with the decree of 11 April 2014 adapting the funding of higher education institutions to the</p> latest restructuring of higher education, it appears from the information you have provided and/or at our disposal that, per the meaning of the aforementioned decree, you are ineligible for funding. 
    <p>However, if you have specific arguments to put forward, you can apply for a faculty exemption with a view to enrolment. To do so, please contact your</p> faculty (<a href="{contact_link}">{contact_link}</a>) as soon as possible to learn how to apply for an exemption.
    <p>For your information, and as a general rule, an exemption application must be made in writing and accompanied by a curriculum vitae, a letter of</p> motivation and a copy of the detailed results of all previous years of higher education (transcripts). 
    <p>The faculty will inform the Enrolment Office of its decision. If the faculty’s decision is favourable, the Enrolment Office will validate your</p> application for (re)enrolment as soon as it is received. If the decision is not favourable, you will receive as soon as possible an official letter denying enrolment.
    ...
    <p>Après analyse de votre curriculum académique et conformément au décret du 11 avril 2014 adaptant le financement des établissements d'enseignement</p> supérieur à la nouvelle organisation des études, il ressort des informations que vous nous avez fournies et/ou dont nous disposons que vous n’êtes pas finançable au sens du décret précité. 
    <p>Toutefois, si vous disposez d’arguments particuliers à faire valoir, vous pouvez introduire une demande de dérogation facultaire en vue d’une</p> inscription. Pour ce faire, veuillez contacter votre faculté (<a href="{contact_link}">{contact_link}</a>) dans les plus brefs délais afin de connaître les modalités en vue d'introduire une demande de dérogation.
    <p>Pour votre information et de manière générale, une demande de dérogation doit être introduite par écrit et être accompagnée d'un curriculum vitae, d’une</p> lettre de motivation et d'une copie des résultats détaillés de toutes les années d'études supérieures antérieures (relevés de notes). 
    <p>La faculté communiquera sa décision au Service des inscriptions. En cas de décision favorable de la faculté et dès sa réception, le Service des</p> inscriptions validera votre demande de (ré)inscription. Dans le cas contraire, un courrier officiel de refus d’inscription vous parviendra dans les meilleurs délais. 
    <p>Consciente de la déception que ce courrier pourrait susciter, nous vous prions néanmoins d’agréer, {greetings_end}, l'expression de nos salutations</p> distinguées. 
