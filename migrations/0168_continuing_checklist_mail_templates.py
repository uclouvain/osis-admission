...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('admission', '0167_continuing_education_checklist_student_report'),
    ]
    ...
    operations = [
        MailTemplateMigration(
            ...
            {
                'en': MAIL_HEADER_EN + '''<p>We are pleased to inform you that your application for admission to the
                ...
                ''' + MAIL_FOOTER_EN,
                'fr-be': MAIL_HEADER_FR + '''<p>En réponse à votre demande d’admission au programme 
        ...
        MailTemplateMigration(
            ...
            {
                'en': MAIL_HEADER_EN + '''<p>We regret to inform you that we are unable to accept your application
                    for admission to the {training_acronym} - {training_title} course for the following reason(s): 
                    {reasons}</p>
                ''' + MAIL_FOOTER_EN,
                'fr-be': MAIL_HEADER_FR + '''<p>En réponse à votre demande d’admission pour la formation 
        ...
        MailTemplateMigration(
            ...
            {
                'en': MAIL_HEADER_EN + '''<p>Your application for admission to the {training_acronym} - {training_title} 
        ...
        MailTemplateMigration(
            ...
            {
                'en': MAIL_HEADER_EN + '''<p>Your application for the course {training_acronym} - {training_title} is 
                    now cancelled.</p>
                ''' + MAIL_FOOTER_EN,
                'fr-be': MAIL_HEADER_FR + '''<p>Votre demande d'inscription pour la formation {training_acronym} 
        ...
        MailTemplateMigration(
            ...
            },
            {
                ...
                ''' + MAIL_FOOTER_EN,
                'fr-be': MAIL_HEADER_FR + '''En réponse à votre demande d’admission au programme 
        ...
        MailTemplateMigration(
            ...
            },
            {
                ...
                'fr-be': '''<p>Bonjour,</p>
                    ...
                    <p>{comment}</p>
                    <p>La demande est accessible via l'adresse suivante [lien vers la demande osis back office]</p>
                    <p>{sender_name}</p>
                ''',
            },
        ),
