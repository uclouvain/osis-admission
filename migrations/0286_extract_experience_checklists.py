...
def extract_experience_checklist_migration(apps, schema_editor):
    ...
    extract_experience_checklist(
        ...
        admission_educational_valuated_experiences_model=apps.get_model(
            'admission',
            'AdmissionEducationalValuatedExperiences',
        ),
        inscription_programme_annuel_model=apps.get_model('epc', 'InscriptionProgrammeAnnuel'),
        admission_professional_valuated_experiences_model=apps.get_model(
            'admission',
...
class Migration(migrations.Migration):
    dependencies = [
        ("admission", "0285_extract_personal_data_checklist"),
