...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('admission', '0235_generaleducationadmission_reorientation_form'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        "GENERAL_RECAP",
                        "PDF recap for a general education admission",
                    ),
                    (
                        "CONTINUING_RECAP",
                        "PDF recap for a continuing education admission",
                    ),
                    (
                        "DOCTORATE_RECAP",
                        "PDF recap for a doctorate education admission",
                    ),
                    (
                        "GENERAL_MERGE",
                        "Merging of each document field of a general proposition into one PDF",
                    ),
                    (
                        "CONTINUING_MERGE",
                    ...
                    (
                        "DOCTORATE_MERGE",
                        "Merging of each document field of a doctorate proposition into one PDF",
                    ),
                    (
                        "GENERAL_FOLDER",
                        "Analysis folder for a general education admission",
                    ),
                    (
                        "CONTINUING_FOLDER",
                        "Analysis folder for a continuing education admission",
                    ),
                    (
                        "DOCTORATE_FOLDER",
                        "Analysis folder for a doctorate education admission",
                    ),
                ],
                max_length=20,
            ),
