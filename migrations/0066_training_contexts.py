...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=admission.models.cdd_config.TranslatedMultilineField(default=admission.models.cdd_config.default_complementary_course_types, verbose_name='COURSE types for complementary training'),
        ),
        migrations.AddField(
            model_name='cddconfiguration',
