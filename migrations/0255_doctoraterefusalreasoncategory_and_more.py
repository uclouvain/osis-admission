...
def populate_refusal_reasons(apps, schema_editor):
    ...
    category_reasons = {
        ...
        'Finançabilité': [
            ...
            "Vous ne remplissez pas les conditions de finançabilité liées à la nationalité (art. 3).",
            "Votre demande d'inscription vise des études qui ne donnent pas lieu à un financement (art. 2) - AESS / CAEAS",
            "Vous ne remplissez plus les conditions académiques de finançabilité (art. 5).",
        ],
    }
