...
def extract_personal_data_checklist(person_model_class):
    ...
    # Set the priorities of the statuses (FRAUDEUR > VALIDEES > A_COMPLETER > TOILETTEES > A_TRAITER)
    statuses_indexes: dict[str, int] = {
        ...
        ChoixStatutValidationDonneesPersonnelles.VALIDEES.name: 3,
        ChoixStatutValidationDonneesPersonnelles.FRAUDEUR.name: 4,
    }
