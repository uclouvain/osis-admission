    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', admission.contrib.models.form_item.TranslatedJSONField(blank=True, default={}, validators=[admission.contrib.models.form_item.is_valid_translated_json_field], verbose_name='Title')),
                ('text', admission.contrib.models.form_item.TranslatedJSONField(blank=True, default={}, validators=[admission.contrib.models.form_item.is_valid_translated_json_field], verbose_name='Text')),
                ('help_text', admission.contrib.models.form_item.TranslatedJSONField(blank=True, default={}, validators=[admission.contrib.models.form_item.is_valid_translated_json_field], verbose_name='Help text')),
