    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default=(('MAIN_PROMOTER', 'Main promoter'), ('PROMOTER', 'Supervisor'), ('CA_MEMBER', 'CA Member')), max_length=50)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('financing_type', models.CharField(blank=True, choices=[('WORK_CONTRACT', 'WORK_CONTRACT'), ('SEARCH_SCHOLARSHIP', 'SEARCH_SCHOLARSHIP'), ('SELF_FUNDING', 'SELF_FUNDING')], default='', max_length=255, verbose_name='Funding type')),
                ...
                ('scholarship_grant', models.CharField(blank=True, default='', max_length=255, verbose_name='Research scholarship')),
                ...
                ('gantt_graph', osis_document.contrib.fields.FileField(base_field=models.UUIDField(), default=list, size=None, verbose_name='Gantt chart')),
