    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'entity',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='base.Entity'),
                ),
                (
                    'person',
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "Role: Supervisor",
                "verbose_name_plural": "Role: Supervisors",
            },
        ),
        migrations.CreateModel(
            name='JurySecretary',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'type',
                    models.CharField(
                        choices=[('ADMISSION', 'Admission'), ('PRE_ADMISSION', 'Pre-admission')],
                        db_index=True,
                        default='ADMISSION',
                        max_length=255,
                        verbose_name='Type',
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[('ECONOMY', 'ECONOMY'), ('MANAGEMENT', 'MANAGEMENT')],
                        default='',
                        max_length=255,
                        verbose_name='Bureau',
                    ),
                ...
                (
                    ...
                    models.CharField(blank=True, default='', max_length=255, verbose_name='Working contract type'),
                ),
                ('financing_eft', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='EFT')),
                (
                    'scholarship_grant',
                    models.CharField(blank=True, default='', max_length=255, verbose_name='Research scholarship'),
                ),
                (
                    'planned_duration',
                ...
                (
                    'project_title',
                    models.CharField(blank=True, default='', max_length=1023, verbose_name='Project title'),
                ),
                ('project_abstract', models.TextField(blank=True, default='', verbose_name='Abstract')),
                (
                    'thesis_language',
                    models.CharField(blank=True, default='', max_length=255, verbose_name='Thesis language'),
                ),
                (
                    'project_document',
                ...
                (
                    ...
                    models.CharField(blank=True, default='', max_length=255, verbose_name='Institution'),
                ),
                ...
                (
                    ...
                    models.CharField(blank=True, default='', max_length=255, verbose_name='No defense reason'),
                ),
