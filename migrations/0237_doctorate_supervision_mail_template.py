        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ('EN_ATTENTE_DE_SIGNATURE', 'In the process of signing'),
                    ('CONFIRMEE', 'Application confirmed'),
                    ('ANNULEE', 'Cancelled application'),
                    ('TRAITEMENT_FAC', 'Processing by Fac/CDD'),
                    ('A_COMPLETER_POUR_FAC', 'To be completed for Fac/CDD'),
                    ('COMPLETEE_POUR_FAC', 'Completed for Fac/CDD'),
                    ('RETOUR_DE_FAC', 'Feedback from Fac/CDD'),
                    ('CA_A_COMPLETER', 'Support committee to be completed'),
                    ('CA_EN_ATTENTE_DE_SIGNATURE', 'In the process of re-signing'),
