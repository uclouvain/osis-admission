    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.CharField(blank=True, choices=[('PERE', 'My father'), ('MERE', 'My mother'), ('TUTEUR_LEGAL', 'My legal tutor'), ('CONJOINT', 'My partner'), ('COHABITANT_LEGAL', 'My legal cohabitant')], default='', max_length=32, verbose_name='Relationship')),
                ...
                ('sport_affiliation', models.CharField(blank=True, choices=[('LOUVAIN_WOLUWE', 'Yes, in Louvain-la-Neuve and/or Woluwe-Saint-Lambert (60 EUR)'), ('MONS_UCL', 'Yes, in Mons and other UCLouvain sites (60 EUR)'), ('MONS', 'Yes, only in Mons (10 EUR)'), ('SAINT_GILLES_UCL', 'Yes, in Saint-Gilles and other UCLouvain sites (60 EUR)'), ('SAINT_GILLES', 'Yes, only in Saint-Gilles (10 EUR)'), ('TOURNAI_UCL', 'Yes, in Tournai and other UCLouvain sites (60 EUR)'), ('TOURNAI', 'Yes, only in Tournai (10 EUR)'), ('NON', 'No')], default='', max_length=32, verbose_name='Sport affiliation')),
