    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_status', models.CharField(blank=True, choices=[('UNSUBMITTED', 'Unsubmitted for publication'), ('SUBMITTED', 'Submitted for publication'), ('IN_REVIEW', 'Awaiting approval'), ('ACCEPTED', 'Accepted'), ('PUBLISHED', 'Published')], max_length=100, default='')),
