...
class ExamFormViewTestCase(TestCase):
    @classmethod
    ...
    def setUp(self):
        self.url = resolve_url('admission:general-education:update:exam', uuid=self.general_admission.uuid)
    ...
    def test_post_with_sic_manager_user_is_allowed(self):
        self.client.force_login(self.sic_manager_user)
