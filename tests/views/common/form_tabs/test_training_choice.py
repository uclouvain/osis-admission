...
class TrainingChoiceFormViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.first_campus = Campus.objects.get(external_id=CampusFactory(name='Mons').external_id)
    ...
    def test_training_choice_for_master_form_initialization(self):
        ...
        self.assertEqual(form.initial['campus'], 'Mons')
        self.assertCountEqual(form.fields['campus'].choices, [['Mons', 'Mons']])
