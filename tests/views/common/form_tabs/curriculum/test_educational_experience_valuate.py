...
class CurriculumEducationalExperienceValuateViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url_to_redirect = resolve_url('admission:all-list')
    ...
    def test_valuate_experience_from_curriculum_and_redirect(self):
        ...
        expected_url = f'{self.url_to_redirect}#custom_hash'

        response = self.client.post(f'{self.valuate_url}?next={self.url_to_redirect}&next_hash_url=custom_hash')
    ...
    def test_valuate_experience_from_doctorate_curriculum_is_allowed_for_sic_users(self):
        ...
        response = self.client.post(
            f'{self.doctorate_valuate_url}?next={self.url_to_redirect}&next_hash_url=custom_hash'
        )
