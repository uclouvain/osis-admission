...
class DoctorateAccountingFormViewTestCase(TestCase):
    @classmethod
    ...
    def setUp(self):
        ...
        # Targeted url
        self.form_url = resolve_url('admission:doctorate:update:accounting', uuid=self.doctorate_admission.uuid)
        self.detail_url = resolve_url('admission:doctorate:accounting', uuid=self.doctorate_admission.uuid)
    ...
    def test_accounting_access(self):
    ...
    def test_accounting_form_initialization(self):
        ...
        self.assertEqual(response.context['is_general'], False)

        accounting = response.context['accounting']
        self.assertEqual(accounting['demande_allocation_d_etudes_communaute_francaise_belgique'], None)
        self.assertEqual(accounting['enfant_personnel'], None)
        self.assertEqual(accounting['type_situation_assimilation'], TypeSituationAssimilation.AUCUNE_ASSIMILATION.name)
        self.assertEqual(accounting['affiliation_sport'], '')
        ...
        self.assertEqual(form.fields['demande_allocation_d_etudes_communaute_francaise_belgique'].required, False)
        self.assertEqual(form.fields['enfant_personnel'].required, False)
    ...
    def test_accounting_form_initialization_with_previous_experiences(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_accounting_form_initialization_without_assimilation(self):
        self.client.force_login(self.sic_manager_user)

        # No country of citizenship -> no assimilation
        self.doctorate_admission.candidate.country_of_citizenship = None
        ...
        self.doctorate_admission.candidate.country_of_citizenship = CountryFactory(european_union=True)
        self.doctorate_admission.candidate.save()
    ...
    def test_post_accounting_form_with_no_data(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form(self):
        self.client.force_login(self.sic_manager_user)
        ...
        accounting: Accounting = self.doctorate_admission.accounting

        self.assertEqual(accounting.institute_absence_debts_certificate, [])
        self.assertEqual(accounting.french_community_study_allowance_application, None)
        self.assertEqual(accounting.is_staff_child, None)
    ...
    def test_post_accounting_form_with_iban_number(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form_with_other_account_number(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form_with_first_assimilation(self):
        self.client.force_login(self.sic_manager_user)
        ...
        accounting = self.doctorate_admission.accounting
    ...
    def test_post_accounting_form_with_second_assimilation(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form_with_third_assimilation(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form_with_fourth_assimilation(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form_with_fifth_assimilation(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form_with_sixth_assimilation(self):
        self.client.force_login(self.sic_manager_user)
    ...
    def test_post_accounting_form_with_seventh_assimilation(self):
        self.client.force_login(self.sic_manager_user)
