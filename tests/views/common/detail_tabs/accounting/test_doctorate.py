...
from admission.ddd.admission.enums import TypeSituationAssimilation, ChoixTypeCompteBancaire
...
class DoctorateAccountingDetailViewTestCase(TestCase):
    @classmethod
    ...
    def test_doctorate_accounting_access(self):
    ...
    def test_get_doctorate_accounting(self):
        self.client.force_login(self.sic_manager_user)
        response = self.client.get(self.url)
