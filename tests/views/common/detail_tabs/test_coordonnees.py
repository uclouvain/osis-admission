...
class CoordonneesDetailViewTestCase(TestCase):
    ...
    def test_doctorate_coordonnes_detail_doctorate_committee_member(self):
    ...
    def test_doctorate_coordonnees_detail_sic_manager(self):
        ...
        self.assertEqual(response.context['admission'].uuid, self.confirmed_doctorate_admission.uuid)
        self.assertEqual(
            response.context.get('profil_candidat'),
            ProfilCandidatDTO(
                nom='Doe',
