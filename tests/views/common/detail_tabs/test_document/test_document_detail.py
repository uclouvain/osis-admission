...
class DocumentDetailTestCase(BaseDocumentViewTestCase):
    ...
    def test_general_document_detail_fac_manager(self, frozen_time):
        ...
        SpecificQuestionAnswer.objects.filter(admission=self.general_admission, form_item__uuid=specific_question_uuid).delete()
    ...
    def test_doctorate_document_detail_fac_manager(self, frozen_time):
        ...
        SpecificQuestionAnswer.objects.filter(admission=self.doctorate_admission, form_item__uuid=specific_question_uuid).delete()
