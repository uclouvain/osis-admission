...
class InProgressDocumentTestCase(BaseDocumentViewTestCase):
    ...
    @freezegun.freeze_time('2022-01-01')
    def test_doctorate_document_detail_cdd_manager_when_in_progress(self):
        self.doctorate_admission.status = ChoixStatutPropositionContinue.EN_BROUILLON.name
        self.doctorate_admission.save(update_fields=['status'])
    ...
    def test_doctorate_cdd_manager_generated_in_progress_analysis_folder(self):
        self._mock_folder_generation()
