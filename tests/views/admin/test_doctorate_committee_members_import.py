...
class DoctorateCommitteeMembersImportViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.person_1 = PersonFactory(first_name='John', last_name='Doe')
        cls.person_2 = PersonFactory(first_name='Jane', last_name='Foe')
        cls.person_3 = PersonFactory(first_name='Jim', last_name='Poe')
        cls.person_4 = PersonFactory(first_name='Jim', last_name='Poe')
