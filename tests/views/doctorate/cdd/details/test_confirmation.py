...
class CddDoctorateAdmissionConfirmationDetailViewTestCase(TestCase):
    ...
    def test_confirmation_detail_candidate_user(self):
        ...
        url = reverse('admission:doctorate:cdd:confirmation', args=[self.admission_without_confirmation_paper.uuid])
    ...
    def test_confirmation_detail_cdd_user_with_unknown_doctorate(self):
        ...
        url = reverse('admission:doctorate:cdd:confirmation', args=[uuid.uuid4()])
    ...
    def test_confirmation_detail_cdd_user_with_confirmation_papers(self):
        ...
        url = reverse('admission:doctorate:cdd:confirmation', args=[self.admission_with_confirmation_papers.uuid])
