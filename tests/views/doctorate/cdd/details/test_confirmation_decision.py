...
class CddDoctorateAdmissionConfirmationSuccessDecisionViewTestCase(TestCase):
    ...
    @classmethod
    @patch('osis_document.api.utils.confirm_remote_upload', return_value='4bdffb42-552d-415d-9e4c-725f10dce228')
    @patch('osis_document.api.utils.get_remote_metadata', return_value={"name": "test.pdf"})
    @patch('osis_document.api.utils.get_remote_token', return_value='foobar')
    def setUpClass(cls, confirm_remote_token, get_remote_metadata, confirm_remote_upload):
        super().setUpClass()
    ...
    @patch('osis_document.api.utils.get_remote_metadata', return_value={"name": "test.pdf"})
    @patch('osis_document.api.utils.get_remote_token', return_value='foobar')
    def test_confirmation_success_decision_cdd_user_with_confirmation_paper(
        self,
        confirm_remote_token,
        get_remote_metadata,
    ...
    @patch('osis_document.api.utils.get_remote_metadata', return_value={"name": "test.pdf"})
    @patch('osis_document.api.utils.get_remote_token', return_value='foobar')
    def test_confirmation_success_decision_cdd_user_with_incomplete_confirmation_paper(
        self,
        confirm_remote_token,
        get_remote_metadata,
        confirm_remote_upload,
