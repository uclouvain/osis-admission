...
class SicPatchMixin(TestCase):
    def setUp(self) -> None:
        ...
        patcher = mock.patch(
            'admission.infrastructure.admission.doctorat.preparation.domain.service.notification.get_remote_token'
        )
        ...
        patcher = mock.patch(
            'admission.infrastructure.admission.doctorat.preparation.domain.service.notification.get_remote_tokens'
        )
        patched = patcher.start()
