...
class SicDecisionChangeStatusViewTestCase(SicPatchMixin, TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = resolve_url(
            'admission:doctorate:sic-decision-change-status',
    ...
    def test_post_as_sic_user(self):
        ...
        self.assertEqual(self.admission.status, ChoixStatutPropositionDoctorale.CONFIRMEE.name)
        ...
        self.assertEqual(len(HistoryEntry.objects.filter(object_uuid=self.admission.uuid)), 1)
