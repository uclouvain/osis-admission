...
class ContingenteManageViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        cls.user = SicManagementRoleFactory().person.user

        GeneralEducationTrainingFactory(
            academic_year__year=2026,
            acronym=CODE_BACHELIER_VETERINAIRE,
        )
    ...
    def test_contingente_training_manage_view_get(self):
        ...
        response = self.client.get(reverse('admission:contingente:training') + f'?training={CODE_BACHELIER_VETERINAIRE}')
