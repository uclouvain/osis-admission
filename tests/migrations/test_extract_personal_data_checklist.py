...
class ExtractPersonalDataChecklistTestCase(TestCase):
    ...
    def test_update_if_the_person_has_a_checklist_in_his_single_admission(self):
        ...
        # Test with the old value of the cleaned status
        admission.checklist['current']['donnees_personnelles'] = {'statut': self.cleaned_status.statut.name}
        admission.save()
        ...
        self.assertEqual(person.personal_data_validation_status, self.cleaned_status.identifiant)
