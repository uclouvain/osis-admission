...
class GeneralAdmissionRequestedDocumentListApiTestCase(BaseAdmissionRequestedDocumentListApiTestCase):
    ...
    def test_post_requested_documents(self):
        ...
        with mock.patch('osis_document_components.services.get_several_remote_metadata') as get_several_remote_metadata_patcher:
            ...
            self.launch_post_processing_patcher.assert_called_once_with(
                uuid_list=[
                    '8f6b07ad-bac9-4166-a913-33f52c6e6800-uuid',
                    '8f6b07ad-bac9-4166-a913-33f52c6e6801-uuid',
                ],
...
@override_settings(OSIS_DOCUMENT_BASE_URL='http://dummyurl/')
class DoctorateAdmissionRequestedDocumentListApiTestCase(BaseAdmissionRequestedDocumentListApiTestCase):
    def setUp(self) -> None:
        super().setUp()
        ...
        self.url = resolve_url('admission_api_v1:doctorate_documents', uuid=self.admission.uuid)
    ...
    def test_only_retrieve_requested_documents_of_valuated_cv_experiences(self):
        ...
        educational_experience = self.admission.candidate.educationalexperience_set.first()
        non_educational_experience = self.admission.candidate.professionalexperience_set.first()
        other_admission = DoctorateAdmissionFactory(candidate=self.admission.candidate)
