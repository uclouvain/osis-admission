...
class LastConfirmationAPIViewTestCase(APITestCase):
    ...
    def test_put_confirmation_student(self):
        ...
        self.assertEqual(confirmation_paper.research_report, [])
        self.assertEqual(confirmation_paper.supervisor_panel_report, [])
        self.assertEqual(confirmation_paper.research_mandate_renewal_opinion, [])
