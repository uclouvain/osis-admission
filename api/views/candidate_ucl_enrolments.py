...
from admission.api.serializers import (
    CandidateDeliberationSerializer,
...
class CandidateDeliberationView(APIPermissionRequiredMixin, RetrieveAPIView):
    name = "candidate_deliberation"
    permission_classes = [IsListingOrHasNotAlreadyCreatedPermission]
    serializer_class = CandidateDeliberationSerializer

    def get_object(self):
        return {
            'est_delibere': message_bus_instance.invoke(
                CandidatEstDelibereQuery(
