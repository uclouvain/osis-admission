            ...
            if specific_question_answers is not None:
                ...
                for form_item_uuid, answer in specific_question_answers.items():
                    SpecificQuestionAnswer.objects.update_or_create(
                        ...
                        defaults={
                            'file': answer if form_items[form_item_uuid].type == TypeItemFormulaire.DOCUMENT.name else None,
                            'answer': answer if form_items[form_item_uuid].type != TypeItemFormulaire.DOCUMENT.name else None,
                        },
                    )
            else:
