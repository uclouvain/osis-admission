...
class HighSchoolDiplomaSerializer(serializers.Serializer):
    graduated_from_high_school = serializers.ChoiceField(
        source='secondarystudies.got_diploma',
        required=False,
        allow_blank=True,
        choices=GotDiploma.choices(),
    )
    graduated_from_high_school_year = RelatedAcademicYearField(
        source='secondarystudies.academic_graduation_year',
        required=False,
        allow_null=True,
    )
    ...
    def load_diploma(instance):
        ...
        if not hasattr(instance, 'secondarystudies'):
            instance.secondarystudies = SecondaryStudies(person=instance)
    ...
    def update(self, instance, validated_data):
        ...
        if not self.get_is_valuated(instance):
            ...
            instance.secondarystudies.got_diploma = validated_data.get('graduated_from_high_school')
            instance.secondarystudies.academic_graduation_year = validated_data.get('graduated_from_high_school_year')
            instance.secondarystudies.save()
        ...
        if belgian_diploma_data:
            ...
            if instance.secondarystudies.got_diploma not in CHOIX_DIPLOME_OBTENU:
                ...
                for diploma in [instance.belgian_diploma, instance.foreign_diploma]:
                    if diploma and diploma.academic_graduation_year != instance.secondarystudies.academic_graduation_year:
                        diploma.academic_graduation_year = instance.secondarystudies.academic_graduation_year
                        diploma.save(update_fields=['academic_graduation_year'])

            if instance.secondarystudies.got_diploma != GotDiploma.NO.name:
