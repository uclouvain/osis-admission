...
urlpatterns = [
    ...
    path('propositions/candidate-deliberation', views.CandidateDeliberationView),
    ...
    path('person_last_enrolment', views.CommonPersonLastEnrolmentViewSet),
    ...
    path(
        'propositions/continuing-education/<uuid:uuid>/person_last_enrolment',
        views.ContinuingPersonLastEnrolmentViewSet,
    ),
