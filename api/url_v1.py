...
urlpatterns = [
    ...
    path('curriculum/<int:xp>', views.CurriculumExperienceUpdateAndDeleteView),
    ...
    path('propositions/<uuid:uuid>/curriculum/<int:xp>', views.CurriculumExperienceUpdateAndDeleteView),
