...
from admission.tasks.generate_admission_folder import (
    ...
    doctorate_education_admission_analysis_folder_from_task,
)
...
class Command(BaseCommand):
    task_operation_by_type = {
        ...
        AdmissionTask.TaskType.DOCTORATE_FOLDER.name: doctorate_education_admission_analysis_folder_from_task,
    }
