...
templates.register(
    ADMISSION_EMAIL_DECISION_APPROVAL,
    description=_(
        'Email sent to the candidate when IUFC approve the application.',
    ),
    tag=CONTINUING_ADMISSION_TAG,
    tokens=CHECKLIST_TOKENS,
)

ADMISSION_EMAIL_DECISION_IUFC_COMMENT_FOR_FAC = 'osis-admission-continuing-education-checklist-decision-iufc-comment-for-fac'
templates.register(
