...
from admission.ddd.admission.formation_generale.domain.model.enums import (
    ...
    PoursuiteDeCycle, RaisonPlusieursDemandesMemesCycleEtAnnee,
)
...
class PropositionRepository(GlobalPropositionRepository, IPropositionRepository):
        ...
        admission, _ = GeneralEducationAdmission.objects.update_or_create(
            ...
            defaults={
                **modified_at_fields,
                ...
                'several_admissions_same_cycle_same_year_reason': entity.raison_plusieurs_demandes_meme_cycle_meme_annee.name if entity.raison_plusieurs_demandes_meme_cycle_meme_annee else '',
                'several_admissions_same_cycle_same_year_justification': entity.justification_textuelle_plusieurs_demandes_meme_cycle_meme_annee,
            },
        )
    ...
    def _load(cls, admission: 'GeneralEducationAdmission') -> 'Proposition':
        ...
        return Proposition(
            ...
            raison_plusieurs_demandes_meme_cycle_meme_annee=getattr(RaisonPlusieursDemandesMemesCycleEtAnnee, admission.several_admissions_same_cycle_same_year_reason, None),
            justification_textuelle_plusieurs_demandes_meme_cycle_meme_annee=admission.several_admissions_same_cycle_same_year_justification,
        )
