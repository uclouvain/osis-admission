...
class ProfilCandidatTranslator(IProfilCandidatTranslator):
    ...
    def _get_secondary_studies_dto(
        ...
        return EtudesSecondairesAdmissionDTO(
            ...
            annee_diplome_etudes_secondaires=(
                ...
                if candidate.highschooldiploma.academic_graduation_year
                else None
            ),
            diplome_belge=(
                DiplomeBelgeEtudesSecondairesDTO(
    ...
    def _get_academic_experiences_dtos(
        ...
        filters = {}
        if matricule:
            filters.update({'educational_experience__person__global_id': matricule})
        if uuid_experience:
            filters.update({'educational_experience__uuid': uuid_experience})
