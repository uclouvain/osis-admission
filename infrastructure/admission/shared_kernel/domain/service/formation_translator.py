...
class BaseFormationTranslator(IBaseFormationTranslator):
    @classmethod
    def recuperer_informations_formations_inscrites(
        ...
        return {
            (training.acronym, training.year): FormationInscriteDTO(
                ...
                annee=training.year,
                intitule_fr=training.title_fr,
                intitule_en=training.title_en,
                lieu_enseignement=training.main_teaching_campus_name,
                type=training.type,
            )
