...
from infrastructure.condition_acces.repository.titre_acces_repository import TitreAccesRepository


class TitreAccesTranslator(ITitreAccesTranslator):
    @classmethod
    def search_dto_by_proposition(
        ...
        return TitreAccesRepository.search_dto_by_proposition(
    ...
    def search_by_proposition(
        ...
        return TitreAccesRepository.search_by_proposition(
            proposition_identity,
            experience_parcours_interne_translator,
            seulement_selectionnes,
        )
    ...
    def save(cls, entity: TitreAccesSelectionnable) -> None:
        TitreAccesRepository.save(entity)
