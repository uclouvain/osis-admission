...
from admission.ddd.admission.projet_doctoral.preparation.domain.model._detail_projet import (
...
from admission.ddd.admission.projet_doctoral.preparation.domain.model._institut import (
    InstitutIdentity,
)
from admission.ddd.admission.projet_doctoral.preparation.domain.model.doctorat import (
    DoctoratIdentity,
)
from admission.ddd.admission.projet_doctoral.preparation.domain.model.proposition import (
    Proposition,
    PropositionIdentity,
)
...
from admission.ddd.admission.projet_doctoral.preparation.dtos import (
    PropositionDTO,
)
from admission.ddd.admission.projet_doctoral.preparation.repository.i_proposition import (
    IPropositionRepository,
)
from admission.infrastructure.admission.projet_doctoral.preparation.domain.service.doctorat import DoctoratTranslator
