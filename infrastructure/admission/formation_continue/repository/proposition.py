...
from admission.models import ContinuingEducationAdmissionProxy, AdmissionFormItem
...
class PropositionRepository(GlobalPropositionRepository, IPropositionRepository):
    ...
    def save(cls, entity: 'Proposition') -> None:
        ...
        SpecificQuestionAnswer.objects.bulk_create(answers_not_documents, update_conflicts=True, update_fields=['file', 'answer'], unique_fields=['admission', 'form_item'])
