...
from admission.ddd.admission.formation_continue.domain.model._comptabilite import (
    Comptabilite,
...
def get_accounting_from_admission(admission: ContinuingEducationAdmission) -> Comptabilite:
