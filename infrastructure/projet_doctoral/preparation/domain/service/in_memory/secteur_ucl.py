...
from admission.ddd.projet_doctoral.preparation.test.factory.secteur_ucl import SSHEntiteFactory, SSSEntiteFactory
...
class SecteurUclInMemoryTranslator(ISecteurUclTranslator):
    ...
    def get(cls, sigle_entite: str) -> 'EntiteUclDTO':
        return list(
            ...
            for e in cls.entites
            if cls.commission_sector_mapping.get(sigle_entite) == e.entity_id.sigle
        )[0]
