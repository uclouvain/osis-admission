...
class ProgramManager(EducationGroupRoleModel):
    ...
    def rule_set(cls):
        ruleset = {
            ...
            'admission.add_supervision_member': is_part_of_education_group & doctorate.is_draft & ~is_sent_to_epc,
            'admission.remove_supervision_member': is_part_of_education_group & doctorate.is_draft & ~is_sent_to_epc,
