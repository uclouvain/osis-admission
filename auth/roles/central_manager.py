...
is_general_or_has_contingente_scope = (
        (~general.is_contingent_non_resident & has_scope(Scope.GENERAL))
...
class CentralManager(EntityRoleModel):
    ...
    def common_rule_set(cls, is_entity_manager: callable):
        ruleset = {
            # Listings
            'admission.view_enrolment_applications': has_scope(Scope.GENERAL) | has_scope(Scope.CONTINGENTE_NON_RESIDENT),
            ...
            & ((general.in_sic_status & is_general_or_has_contingente_scope) | continuing.in_manager_status | doctorate.in_sic_status)
            & ~is_sent_to_epc
            & ~workflow_injection_signaletique_en_cours,
            ...
            & ((general.is_submitted & is_general_or_has_contingente_scope) | continuing.not_cancelled | doctorate.is_submitted)
            & ~is_sent_to_epc,
            'admission.request_documents': is_entity_manager
            & ((general.in_sic_status & is_general_or_has_contingente_scope) | continuing.can_request_documents | doctorate.in_sic_status)
            & ~is_sent_to_epc,
            ...
            & ((general.in_sic_status & is_general_or_has_contingente_scope) | continuing.is_submitted | doctorate.in_sic_status)
            & ~is_sent_to_epc,
            ...
            'admission.change_payment': is_entity_manager & (general.in_sic_status_or_application_fees & is_general_or_has_contingente_scope) & ~is_sent_to_epc,
            'admission.checklist_faculty_decision_transfer_to_fac': is_entity_manager
            & ((general.can_send_to_fac_faculty_decision & is_general_or_has_contingente_scope) | doctorate.can_send_to_fac_faculty_decision)
            & ~is_sent_to_epc,
            ...
            & ((general.is_submitted & is_general_or_has_contingente_scope) | continuing.is_continuing | doctorate.is_submitted)
            & ~is_sent_to_epc,
            ...
            # Fusion
            'admission.merge_candidate_with_known_person': (has_scope(Scope.GENERAL) | has_scope(Scope.CONTINGENTE_NON_RESIDENT))
            & is_entity_manager
            & is_general_or_has_contingente_scope
            & ~is_sent_to_epc,
