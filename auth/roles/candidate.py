...
_CANDIDATE_RULESET = {
    ...
    'view_admission_exam': common.is_admission_request_author & doctorate.unconfirmed_proposition,
    ...
    'change_admission_exam': common.is_admission_request_author & doctorate.in_progress,
