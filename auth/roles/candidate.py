...
_CANDIDATE_RULESET = {
    ...
    'change_admission_supervision': common.is_admission_request_author & (doctorate.in_progress | doctorate.ca_to_be_completed),
    'request_signatures': common.is_admission_request_author & (doctorate.in_progress | doctorate.ca_to_be_completed),
    'add_supervision_member': common.is_admission_request_author & (doctorate.in_progress | doctorate.ca_to_be_completed),
    'remove_supervision_member': common.is_admission_request_author & (doctorate.in_progress | doctorate.ca_to_be_completed),
    'edit_external_supervision_member': common.is_admission_request_author & (doctorate.in_progress | doctorate.ca_to_be_completed),
