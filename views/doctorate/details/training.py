...
class TrainingActivityFormMixin(AdmissionFormMixin):
...
class TrainingActivityDeleteView(AdmissionFormMixin, generic.DeleteView):
...
class TrainingActivityActionFormMixin(AdmissionFormMixin, SingleObjectMixin, FormMixin):
    model = Activity
    slug_field = 'uuid'
    pk_url_kwarg = "NOT_TO_BE_USED"
    slug_url_kwarg = 'activity_id'
