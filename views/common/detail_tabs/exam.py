...
class ExamDetailView(LoadDossierViewMixin, TemplateView):
    urlpatterns = 'exam'
    template_name = 'admission/details/exam.html'
    ...
    def education_group_year_exam(self):
        try:
            return EducationGroupYearExam.objects.filter(education_group_year=self.admission.training)
